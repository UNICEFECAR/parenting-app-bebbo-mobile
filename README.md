...
12. Steps required while creating Flavour builds for both REMOVED_FACEBOOK_APP_ID1 and REMOVED_FACEBOOK_APP_ID1. 

   **A.** Follow below steps for **REMOVED_FACEBOOK_APP_ID1 Prod and ProdStaging**:

...
````apiUrlDevelop = 'https://bebbodev.app/api' (Server api endPoint)
   facebookAppDisplayName=REMOVED_FACEBOOK_APP_ID1 (For Facebook Analytics. Get these details from Facebook developer console.)
...
xcodebuild -exportArchive -archivePath ios/build/ParentBuddyAppDev.xcarchive -exportOptionsPlist ExportOptionsREMOVED_FACEBOOK_APP_ID1.plist -exportPath ios/build
```

...
const config = {
  ...
  buildForREMOVED_FACEBOOK_APP_ID1: "reraiUmntwana",
  buildFor: "reraiUmntwana", // 'reraiUmntwana'
  maxRelatedArticleSize: 3,
  isArticlePinned: "1",
  articleCategory: "4,1,55,56,3,2", //not used
  articleCategoryIdArray: [
    391, 406, 411, 416, 421, 426, 436, 446, 451, 456, 461, 466
  ],
  ...
  relationShipMotherId: 3401,
  relationShipFatherId: 3406,
  relationShipOtherCaregiverId: 3411,
  relationShipServiceProviderId: 3416,
  femaleData: {
    id: 3391,
    name: "Female",
    unique_name: "female",
  ...
  articleCategoryobj: [
    ...
    { name: "healthAndWellbeingid", id: 391, image: "ic_artl_health" },
    { name: "safetyAndProtection", id: 426, image: "ic_artl_safety" },
    { name: "responsiveParenting", id: 421, image: "ic_artl_responsive" },
    { name: "parentingCorner", id: 411, image: "ic_artl_parenting" },
    { name: "nutritionAndBreastfeeding", id: 406, image: "ic_artl_nutrition" },
  ],
  articleCategoryobjPregnancy: [
    { name: "weekByWeek", id: 436, image: "ic_art_week_by_week" },
    { name: "stayingHealthy", id: 446, image: "ic_art_staying_healthy" },
    {
      name: "preparingForBaby",
      id: 451,
      image: "ic_art_preparing_for_baby",
    ...
    { name: "labourAndBirth", id: 461, image: "ic_art_labour_birth" },
    {
      name: "pregnancyComplication",
      id: 466,
      image: "ic_art_complications",

const ZWen = {
  translation: {
    ...
    checkonce:
      'Rerai Umntwana will localize your content based on your selection of your country and language.',
    country: 'Country',
    language: 'Language',
    walkthroughTextstitle0: 'Welcome Parents!',
    walkthroughTextssubtitle0: 'Discover Rerai Umntwana',
    ...
    tncScreenContent:
      'Rerai Umntwana does not collect or store any personal information. All the information you enter is saved only on your phone.',
    tNccheckbox1:
    ...
    tNcprivacyPolicy: 'Privacy Policy of the Rerai Umntwana application',
    tNccheckbox3:
    ...
    childSetupheader: 'Get the most out of Rerai Umntwana!',
    ...
    childSetupListheader:
      'Rerai Umntwana is getting ready to support your parenting journey!',
    ...
    drawerMenurateTxt: 'Like Rerai Umntwana? Rate it!',
    ...
    settingScreennotiType1: 'I want to receive notifications through Rerai Umntwana.',
    ...
    settingScreennotiInfo:
      "Rerai Umntwana will send you notifications from time to time about new content, important updates or reminders so that you can support your child's growth and development. You can fully disable this function at any point in the app settings, which will result in limited app functionality.",
    ...
    settingScreendownldHeaderText: 'Download Rerai Umntwana content\n',
    ...
    appShareText: 'Download Rerai Umntwana, your pocket partner in parenthood!',
    ...
    downloadUpdatePopupTitle: 'Update new Rerai Umntwana content.',
    downloadUpdatePopupText:
      'It will take a bit of time to update the new Rerai Umntwana content.',
    ...
    importOnboardingText: 'Rerai Umntwana does not collect your personal details.',
    ...
    importOnboardingText2:
      'If you have used Rerai Umntwana on another device and exported your information, you can upload the file to this device now.',
    ...
    helloMessage:
      "Hello{{parentName}}, my name is Rerai Umntwana. I'm here to answer your questions",
    ...
    restOfTheWorldAlertText:
      'By selecting Rest of the world, you will enjoy all features of Rerai Umntwana, but note that vaccinations and health check-ups are not customized to a specific national health program.',
    ...
    serviceProviderHeaderInfoText:
      'Rerai Umntwana is getting ready to support your journey in providing care!',
    serviceProviderHeaderSubInfoText:
      'Rerai Umntwana created a newborn child profile to get you started. You can add more child profiles later.',
  },
};
export default ZWen;

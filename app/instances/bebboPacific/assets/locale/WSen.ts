const WSen = {
  translation: {
    ...
    vaccineModalText:
      "Here you can register, track, and find out more about vaccines recommended in The Ministry of Health's national immunization schedule. Set reminders for vaccinations and receive notifications.",
    hcModalText:

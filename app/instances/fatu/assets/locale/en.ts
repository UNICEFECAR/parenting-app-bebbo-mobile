const en = {
  translation: {
    ...
    checkonce:
      'FATU will localize your content based on your selection of your country and language.',
    country: 'Country',
    language: 'Language',
    walkthroughTextstitle0: 'Welcome Parents!',
    walkthroughTextssubtitle0: 'Discover FATU',
    ...
    tncScreenContent:
      'FATU does not collect or store any personal information. All the information you enter is saved only on your phone.',
    tNccheckbox1:
      'I have read, understood and accepted the Terms and Conditions of the FATU application',
    tncCheckBoxText: 'Terms and Conditions of the FATU application ',
    tNccheckbox2: 'I have read, understood and accepted the',
    tNcprivacyPolicy: 'Privacy Policy of the FATU application',
    tNccheckbox3:
      'I understand that my usage of the app may generate anonymized data, which may be used to improve FATU. While providing this data is not mandatory, I recognize that it can help enhance the overall user experience.',
    tNcprivacyPolicyTitle: 'Privacy Policy',
    tNcacceptbtn: 'I accept the Terms and Conditions',
    loadingText: 'Fetching content…',
    childSetupheader: 'Get the most out of FATU!',
    ...
    childSetupListheader:
      'FATU is getting ready to support your parenting journey!',
    ...
    drawerMenurateTxt: 'Like FATU? Rate it!',
    ...
    settingScreennotiType1: 'I want to receive notifications through FATU.',
    ...
    settingScreennotiInfo:
      "FATU will send you notifications from time to time about new content, important updates or reminders so that you can support your child's growth and development. You can fully disable this function at any point in the app settings, which will result in limited app functionality.",
    ...
    settingScreendownldHeaderText: 'Download FATU content\n',
    ...
    appShareText: 'Download FATU, your pocket partner in parenthood!',
    ...
    downloadUpdatePopupTitle: 'Update new FATU content.',
    downloadUpdatePopupText:
      'It will take a bit of time to update the new FATU content.',
    ...
    importOnboardingText: 'FATU does not collect your personal details.',
    ...
    importOnboardingText2:
      'If you have used FATU on another device and exported your information, you can upload the file to this device now.',
    ...
    helloMessage:
      "Hello{{parentName}}, my name is FATU. I'm here to answer your questions",
    ...
    restOfTheWorldAlertText:
      'By selecting Rest of the world, you will enjoy all features of FATU, but note that vaccinations and health check-ups are not customized to a specific national health program.',
    ...
    donateButton: 'Donate for FATU',
    contactUs: 'Write to us',
    aboutFATUDrawerMenu: 'About {{appName}}',
    welcomeText: 'Welcome!',
    letGetStartedText: "LET'S GET STARTED",
    searchInFATUText: 'Search',
    ...
    serviceProviderHeaderInfoText:
      'FATU is getting ready to support your journey in providing care!',
    serviceProviderHeaderSubInfoText:
      'FATU created a newborn child profile to get you started. You can add more child profiles later.',
  },
};
export default en;

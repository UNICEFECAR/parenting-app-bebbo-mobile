  ...
  useEffect(() => {
    ...
    const getCountryByCountryCode = (countryCode: any): any => {
      for (const country of allCountries) {
        for (const language of country.languages) {
          const [languageCodeFromLuxon, countryCodeFromLuxon] =
            language.luxonLocale.split("-");
    ...
    if (isVisible) {
      ...
      if (userIsOnboarded == true) {
        if (
          props.route.params.country &&
          props.route.params.country != null &&
          props.route.params.country != undefined
        ) {
        ...
        <ButtonPrimary
          onPress={(): any => {
            props.navigation.navigate("LanguageSelection", {
              country: country,
              language: language,
              luxonlocale: luxonLanLocale != undefined ? luxonLanLocale : null,
              deviceLanCode: deviceLanCode != undefined ? deviceLanCode : null,
            });
          }}
        >

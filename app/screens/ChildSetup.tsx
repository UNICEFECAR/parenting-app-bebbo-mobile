...
const ChildSetup = ({ navigation }: Props) => {
  ...
  const [showParentSection, setParentSection] = useState(false);
  ...
  const actionSheetRef2 = createRef<any>();
    ...
    <>
      <View style={{ flex: 1, backgroundColor: headerColor }}>
        ...
        <Modal
          transparent={true}
          animationType={'none'}
          visible={showParentSection}
          onRequestClose={() => {
            // console.log('close modal');
          }}>
              <View style={{ height:200,marginTop:"50%",marginLeft:10,marginRight:10,borderRadius:10,backgroundColor:"#fff" }}>
  
          <View>
<Text style={{textAlign:'center',fontWeight:"bold"}}>{t('successOnboardingImport')}</Text>
<Text style={{textAlign:'center'}}>{t('updateImportText')}</Text>
{/* <ActionSheetProvider> */}

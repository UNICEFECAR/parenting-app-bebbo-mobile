...
// import { buildFor, buildForBangla, buildForREMOVED_FACEBOOK_APP_ID1, shareText } from '@assets/translations/appOfflineData/apiConstants';
...
const CustomDrawerContent = ({ navigation }: any): any => {
  ...
  const onShare = async (): Promise<any> => {
    const localeData = (String(appConfig.buildFor) != appConfig.buildForREMOVED_FACEBOOK_APP_ID1) ? languageCode : "";
      ...
      <View style={styles.containerView}>
        <ScrollView style={styles.scrollViewStyle}>
          ...
          <DrawerLinkView style={{ backgroundColor: aboutAccordValue ? lightShadeColor : bgcolorWhite2 }} onPress={(): any => onChangeAboutAccordValue(!aboutAccordValue)}>
            ...
            <><Heading4 style={styles.headingFlexShrink}>{t('aboutREMOVED_FACEBOOK_APP_ID1DrawerMenu', { appName: t('homeScreenheaderTitle') })}</Heading4></>
            <Icon
              style={styles.iconStyle}
              ...
              <DrawerLinkView
                onPress={(): any => {
                  if (Platform.OS === 'android') {
                    if (String(appConfig.buildFor) == appConfig.buildForREMOVED_FACEBOOK_APP_ID1) {

...
const CustomDrawerContent = ({ navigation }: any) => {
  ...
  // }, [isOpen, activeChild.uuid, allnotis]);
  const onShare = async () => {
    let localeData=(String(buildFor) != buildForREMOVED_FACEBOOK_APP_ID1)?languageCode:"";
          ...
          <DrawerLinkView onPress={() => {
            if(Platform.OS === 'android') {
              ...
              if(String(buildFor) == buildForREMOVED_FACEBOOK_APP_ID1) {
                ...
                Linking.openURL('itms://itunes.apple.com/in/app/apple-store/id1607980150?action=write-review');
              }
            }

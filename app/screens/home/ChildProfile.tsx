...
{/*                             
                            <ParentColView>
                            <Heading4Regular>Your role is</Heading4Regular>
                            </ParentColView>
                            <ParentColView>
                            <Heading4Regular>Father</Heading4Regular>
                            </ParentColView>
                          </ParentRowView>
                          <ParentRowView>
                            <ParentColView>
                            <Heading4Regular>Name</Heading4Regular>
                            </ParentColView>
                            <ParentColView>
                            <Heading4Regular>Antanio</Heading4Regular>
                            </ParentColView> */}
                          </ParentRowView>
                  </ProfileContentView>

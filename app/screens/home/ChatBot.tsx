    ...
    <FlexRow>
      <BotImage>
        <LinearGradient
          ...
          <VectorImage style={{ width: 20, height: 20, borderRadius: 100, resizeMode: 'contain' }} source={buildFor == buildForREMOVED_FACEBOOK_APP_ID1 ? require('@assets/svg/xk/img-logo-chatbot-new.svg') : require('@assets/svg/bebbo/img-logo-chatbot-new.svg')} />
        </LinearGradient>
      </BotImage>
      <BotBubbleContainer>

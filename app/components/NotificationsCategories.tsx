  ...
  return (
    <Pressable
      ...
      style={[
        styles.item,
        {
          backgroundColor: props.data.isActivated
            ? props.data.activatedColor
            : bgcolorWhite2,
        },
      ]}
    >
      ...
      <View style={{ backgroundColor: backgroundColor }}>
        <View style={styles.containerView}>
          <FlexRow>
            <ButtonItem
              data={products[0]}
              setbutton={(): any => handleChange(0)}
            />
            <ButtonItem
              data={products[1]}
              setbutton={(): any => handleChange(1)}
            />
          </FlexRow>
          <FlexRow>
            <ButtonItem
              data={products[2]}
              setbutton={(): any => handleChange(2)}
            />
            <ButtonItem
              data={products[3]}
              setbutton={(): any => handleChange(3)}
            />
          </FlexRow>
        </View>
      </View>

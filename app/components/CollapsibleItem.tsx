    ...
    <>
      <View style={styles.item}>
        <View style={{flex: 1, flexDirection: 'row'}}>
          ...
          <Pressable
            style={{flexDirection: 'row', flex: 8}}
            onPress={() => {
              setIsOPen(!isOPen);
            }}>
        ...
        {isOPen ? (
          <>
            ...
            <View style={{backgroundColor:props.subItemSaperatorColor,margin:5,padding:1}}></View>
            <View>
              ...
              <View style={{flexDirection: 'row'}}>
                ...
                <View style={{flex:5,marginHorizontal:5}}>
                  <Heading5>
                  Child related content goes here, Child related content goes here,
                  </Heading5>
                  <Text style={{textDecorationLine:'underline'}}>
                    View details
                  </Text>

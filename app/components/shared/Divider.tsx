...
border-color:${(props:any):any => props.theme.colors.CHILDDEVELOPMENT_COLOR};
`;

export const DividerArt = styled(Divider)`
border-color:${(props:any):any => props.theme.colors.ARTICLES_COLOR};
margin-top:-2px;
`;
export const DividerAct = styled(Divider)`
border-color:${(props:any):any => props.theme.colors.ACTIVITIES_COLOR};
margin-top:-2px;
`;
...
background:${(props:any):any => props.theme.colors.HEALTHCHECKUP_COLOR};
width:7px;
height:7px;
border-radius:100px;
margin-top:6px;

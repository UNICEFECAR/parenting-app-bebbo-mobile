import { articleCategoryArray, basicPagesUniqueName, childGenderUniqueName, parentGenderUniqueName, relationshipUniqueName } from '@assets/translations/appOfflineData/apiConstants';

...
export const shareText = (String(buildFor) === buildForREMOVED_FACEBOOK_APP_ID1) ? `\n${bebboShareUrl}` : (String(buildFor) === buildForREMOVED_FACEBOOK_APP_ID1) ? `\n${folejaShareUrl}` : `\n${babuniShareUrl}`;
export const shareTextButton = (String(buildFor) === buildForREMOVED_FACEBOOK_APP_ID1) ? bebboShareUrl : (String(buildFor) === buildForREMOVED_FACEBOOK_APP_ID1) ? folejaShareUrl : babuniShareUrl;
...
export const babuniName = 'REMOVED_FACEBOOK_APP_ID1';
...
const selectCountry = () => {
  if(buildFor === 'bangla'){
    return {build:'REMOVED_FACEBOOK_APP_ID1',apiURL :apiREMOVED_FACEBOOK_APP_ID1UrlDevelop }
  } else if(buildFor === 'foleja') {
    return {build:'REMOVED_FACEBOOK_APP_ID1',apiURL :apiUrlDevelop }
  } else {
    return {build:'REMOVED_FACEBOOK_APP_ID1',apiURL :apiUrlDevelop }
  }
}
export const finalUrl = (
  ...
  const baseUrl =  buildFor === String(buildForBangla) ? `${apiREMOVED_FACEBOOK_APP_ID1UrlDevelop}/${apiEndpoint}` :`${apiUrlDevelop}/${apiEndpoint}`;

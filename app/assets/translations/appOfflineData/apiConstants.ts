...
export const restOfTheWorldAlertText = 'By selecting Rest of the world, you will enjoy all features of REMOVED_FACEBOOK_APP_ID1, but note that vaccinations and Health check-ups are not customized to a specific national health program.';

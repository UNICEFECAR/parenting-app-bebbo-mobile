const en = {
        translation: {
                ...
                "walkthroughTextssubtitle2": "to track your child's development, growth, vaccines and health",
                ...
                "tncScreenContent": "REMOVED_FACEBOOK_APP_ID1 does not collect or store any personal information. All the information you enter is saved only on your phone.",
                ...
                "tNccheckbox3": "I understand that my usage of the app may generate anonymized data, which may be used to improve REMOVED_FACEBOOK_APP_ID1. While providing this data is not mandatory, I recognize that it can help enhance the overall user experience.",
                ...
                "childSetupListheader": "REMOVED_FACEBOOK_APP_ID1 is getting ready to support your parenting journey!",
                "childSetupListsubHeader": "If you have any other children aged 0 to 6, you can add them now or later.",
                ...
                "settingScreendownldSubHeader3Text": "Recommended if you plan to use the app offline",
                ...
                "vcReminderDeleteWarning": "Are you sure you want to delete this vaccination reminder?",
                "growthDeleteWarning": "Are you sure you want to delete your child's growth measurement?",
                ...
                "hcReminderDeleteWarning": "Are you sure you want to delete this health check-up reminder?",
                "hcDeleteWarning": "Are you sure you want to delete your child's health check-up?",
                "tabbarLabel1": "Home",
                "tabbarLabel2": "Games ",
                "tabbarLabel3": "Tools",
                "tabbarLabel4": "Advice ",
                ...
                "localizationChangeModalText": "If a new country is selected, the content might change. If choose a new language within the same country the content will remain the same, will be just displayed in the new language selected.",
                "month": "Month",
                ...
                "cancelPopupText": "Content is not fully downloaded. Only limited content will be displayed.",
                "cancelPopUpBtn": "OK",
                "developScreenCompletechartLabel": "Complete",
                "developScreenCompletechartText": "Congratulations, your child has reached all milestones!",
                ...
                "detailScreenNoDataPopupText": "Sorry, the content you are looking for is not available.",
                ...
                "growthModalText": "Enter and keep updating your child's weight and height here and learn how to better support her/his growth.",
                "vaccineModalText": "Here you can register, track, and find out more about vaccines recommended by the World Health Organization's routine immunization calendar (not customized to a specific national calendar). Set reminders for vaccinations and receive notifications.",
                ...
                "hcNoti1": "In this period, {{periodName}}, {{childName}} should have a health checkp-up. Schedule a visit to the doctor.",
                "vcNoti1": "In the period, {{periodName}}, {{childName}} should receive vaccine:  ",
                "alertForExistingMeasuresTitle": "A measurement is already available for this date. Please select another date.",
                "alertForNoTakenVaccinesSelectTitle": "Please select vaccine(s)",
                "importText": "Upload saved data",
                "exportText": "Back up your data",
                "dataConsistency": "For data consistency, please use the same language to transfer data. To continue, please sign in to your Google Drive account to transfer your data.",
                "dataSaver": "Do you want to switch {{toggle}} to a low internet connectivity mode?",
                ...
                "downloadUpdatePopupText": "It will take a bit of time to update the new REMOVED_FACEBOOK_APP_ID1 content.",
                ...
                "newdetailScreenNoDataPopupText": "Sorry, selected Advice/Game is not available. Please download the latest content from Settings.",
                ...
                "importOnboardingText2": "If you have used REMOVED_FACEBOOK_APP_ID1 on another device and exported your information, you can upload the file to this device now.",
                ...
                "hcrNoti1": "Reminder has been set for the Health check-up on {{reminderDateTime}}.",
                ...
                "downloadAllPopupText": "This action will download all app content and we recommend completing this action while connected to Wi-Fi. Do you want to download all content now?",
                ...
                "reminderalertTextDefined": "Reminder date time should be between current and scheduled date time.",
                ...
                "hcrNoti3": "Health check-up has been scheduled on {{reminderDateTime}}, please enter Health check-up details.",
                ...
                "serviceProviderHeaderInfoText" :"REMOVED_FACEBOOK_APP_ID1 is getting ready to support your journey in providing care!",
                "serviceProviderHeaderSubInfoText" :"REMOVED_FACEBOOK_APP_ID1 created a newborn child profile to get you started. You can add more child profiles later.",
              }
}
export default en;
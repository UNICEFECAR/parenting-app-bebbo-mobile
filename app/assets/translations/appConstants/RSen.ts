...
walkthroughTextssubtitle0: "Discover Halo Beba - everything you need as a parent to support your child's development",
...
tNccheckbox1: "I have read, understood and accepted the Terms and Conditions of the Halo Beba application",
tNccheckbox2: "I have read, understood and accepted the",
tNcprivacyPolicy: "Privacy Policy of the Halo Beba application",
tNccheckbox3: "I accept that the anonymized data of my use of the app will be used for the Halo Beba application improvements  (it is not mandatory)",
...
drawerMenurateTxt: "Like Halo Beba? Rate it!",
...
settingScreennotiType1: "I want to receive notifications through Halo Beba",
...
settingScreennotiInfo: "Notifications are published with different frequency, from daily to monthly and are an integral part of Halo Beba's functionality. You can choose to hide notifications on your home screen. You can also fully disable this function at any point in the app settings, which will result in limited app functionality.",
...
appShareText: "Halo Beba App | An App for parents to monitor and guide their child's growth",
